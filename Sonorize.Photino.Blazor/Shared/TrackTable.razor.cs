...
public partial class TrackTable
{
        ...
        return builder =>
    {
        ...
        builder.AddAttribute(8, "onclick", EventCallback.Factory.Create(this, async () =>
        {
            ...
            {
                await OnRowClick.InvokeAsync(song);
            }

            if (OnPlay.HasDelegate && AppSettings.Playback.PlayOnSingleClick)
            {
                await OnPlay.InvokeAsync(index);
            }
        }));
        ...
        builder.AddAttribute(9, "ondblclick", EventCallback.Factory.Create(this, async () =>
        {
            ...
            {
                await OnRowDoubleClick.InvokeAsync(song);
            }
